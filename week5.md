...
- **步驟**：
    1. **觀察與記錄**：仔細觀察這 1 張圖片，記錄其**色彩方案、材質、文字風格、背景、光線方向**等關鍵細節。
    2. **撰寫初版提示語**：根據觀察內容，設計第一版提示語，盡可能細緻描述每個圖像的視覺特徵。
    3. **AI 生成與對比**：使用設計的提示語生成圖像，並與提供的原圖進行**並排對比**，找出主要異同。
    4. **提示語微調與迭代**：根據對比結果，優化提示語，進行至少**三次迭代**，每次僅調整一個關鍵變數（如色彩、材質、光影）。
    5. **最終結果與報告**：選擇最接近的 AI 生成圖像，撰寫**對比分析報告**，包含：
        - 哪些提示語調整最有效？
        - 哪些元素最難還原？為什麼？
        - 如果要再進一步改善，你會怎麼調整？
        - ### **實驗問題**
